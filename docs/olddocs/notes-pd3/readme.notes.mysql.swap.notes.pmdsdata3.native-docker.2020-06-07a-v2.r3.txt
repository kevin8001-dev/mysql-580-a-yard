...
#@  checks
#@  
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@   2020-06-09[Jun-Tue]15-44PM 


mysql  --host=127.0.0.1 --port=3308 -u dg417 -pdg -e "show databases;";

mysql  --host=127.0.0.1 --port=3306 -u dg417 -pdg -e "show databases;";




do not use.. confusing.. ambiguous.
		mysql --protocol=TCP -u dg417 -pdg
...
#@  
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@   2020-06-09[Jun-Tue]15-43PM 

pd3 mysql is on port 3308. how can this work? It didn't Sunday.

albe@pmdsdata3:/srv/dkr/mysql519$ mysql -udg417 -p
Enter password:
Welcome to the MySQL monitor.  Commands end with ; or \g.
